...
map.getView().fit([-6746264.158331, -3748478.621080, -6694583.360121, -3720269.518724], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Cuenca las Tunas</h2>';
        return titleElement;
    })(),
